...
//
$ip = getRealIpAddr();
if($ip == '46.250.13.96222') {
    ?>

    <!-- plugin.js -->
    <script src="/assets/vendor/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="/assets/js/plugins-settings.js?<?= time() ?>"></script>
    ...
    <script src="/assets/js/filters.js?<?= time() ?>"></script>
    <script src="/assets/js/products.js?<?= time() ?>"></script>
    <script src="/assets/js/my_account.js?<?= time() ?>"></script>
    <script src="/assets/js/cart.js?<?= time() ?>"></script>
    ...
    ?>
    <script src="/assets/js/build/plugins.js?<?=time()?>"></script>
    <script src="/assets/js/build/dist.js?<?=time()?>"></script>
    <?php
}
?>
</body>

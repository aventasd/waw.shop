              ...
              <div class="card card-table">
                <div class="card-header"><?=$page['h2_title']?>
                  <div class="tools dropdown"  >
                      <a href="/admin/categories/new" class="btn btn-space btn-success">Create New Category</a>
                      
                        
                  </div>
                </div>
                <div class="card-body">
                  <table id="categoriesTable" class="table table-striped table-hover table-fw-widget">
                    <thead>
                      <tr>

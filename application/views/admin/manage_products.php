              ...
              <div class="card card-table">
                <div class="card-header"><?=$page['h2_title']?>
                  <div class="tools dropdown"  >
                      <a href="/admin/products/new" class="btn btn-space btn-success">Create New Products</a>
                      
                        
                  </div>
                </div>
                <div class="card-body">
                  <table id="productsTable" class="table table-striped table-hover table-fw-widget">
                    <thead>
                      <tr>

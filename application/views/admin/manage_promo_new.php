                    ...
                    <div class="card card-border-color card-border-color-primary">
                     ...
                     <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb page-head-nav">
                          ...
                          <li class="breadcrumb-item"><a href="/admin/promo">Promo Codes</a></li>
                          <li class="breadcrumb-item active">Editing promo code</li>
                        </ol>
                      </nav>
                    </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="code" class="col-12 col-sm-3 col-form-label text-sm-right">Promo Code:</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    ...
                                    <span style="color: gray; font-size: 12px; "> This is what User should INPUT on Chechout to enroll the promo</span>
                                </div>
                            </div>


                            <div class="form-group row">
                                <label for="percent" class="col-12 col-sm-3 col-form-label text-sm-right">Subtotal Discount, %:</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input style="width: 20%" id="percent"  type="text"   name="percent"  placeholder="Set % Subtotal Discount" class="form-control" value="<?php if (!empty($edit['percent'])) { echo $edit['percent']; } ?>"  />
                                    <span style="color: gray; font-size: 12px; ">This discount applies to order subtotal EXCLUDING  shipping cost</span>
                                </div>
                            </div>


                            <div class="form-group row">
                                <label for="percent" class="col-12 col-sm-3 col-form-label text-sm-right">Fixed Amount Discount, $</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input style="width: 20%" id="Fixed Amount Discount"  type="text"   name="amount"  placeholder="Set Fixed Amount Discount" class="form-control" value="<?php if (!empty($edit['amount'])) { echo $edit['amount']; } ?>"  />
                                    <span style="color: gray; font-size: 12px; ">This discount amount subtracts from order subtotal</span>
                                </div>
                            </div>
                        ...
                        -->
                            ...
                            <div class="form-group row pt-1 pb-1">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Promo Status</label>
                                <div class="col-12 col-sm-8 col-lg-6 form-check mt-2">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="status"  value="1"  <?php if ($edit['status'] == 1) {echo 'checked="checked"'; } ?> class="custom-control-input"><span class="custom-control-label">Active</span>
                                    </label>
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="status" value="0" <?php if ($edit['status'] == 0) {echo 'checked="checked"';} ?> class="custom-control-input"><span class="custom-control-label">Disabled</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <p class="text-left">
                                        ...
                                        <input type="submit" name="save" value="Save Changes" class="btn btn-space btn-primary"  />
                                        <button class="btn btn-space btn-secondary go-to-link" data-href="/admin/promo">Cancel</button>
                                    </p>
                                </div>
                            </div>

    ...
    <div class="container-menu-desktop">
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    <a href="/help" class="flex-c-m trans-04 p-lr-25">
                        Help & FAQs
                    </a>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="/" class="logo">
                    <img src="/assets/images/logo_trans.png" alt="WAW Shop Logo">
                </a>
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="/women-featured">Features</a></li>
                        ...
                        <li>
                            <a href="/men">Men</a>
                            <ul class="sub-menu">
                                <li><a href="/men-featured">Features</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="/baby-wellness">Nursing & Feeding</a></li>
                                <li><a href="/baby-toys">Baby Toys</a></li>
                            </ul>
                        </li>

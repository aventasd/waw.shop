                    ...
                    <div class="wrap-slick3 flex-sb flex-w">
                        ...
                        <div class="slick3 gallery-lb">
                            ...
                            <div class="item-slick3" data-thumb="/assets/images/product-detail-02.jpg">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="/assets/images/product-detail-02.jpg" alt="IMG-PRODUCT222">
            ...
            <div class="col-md-6 col-lg-5 p-b-30">
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                    ...
                    <span class="mtext-106 cl2">
                          ...
                          <div class="new-price"><span id="costHTML" class="currency" ><?= $product_size_first['cost'] ?></span></div>
                        <?php if ($product_size_first['oldprice']) { ?>
                            <div id="oldpriceHTML" class="old-price currency"><?= $product_size_first['oldprice'] ?></div>
                        <?php } ?>
                        <?php if ($product_size_first['discount']) { ?>
                            <div id="discountHTML"  class="discount"><sup class="gray"></sup><?= $product_size_first['discount'] ?>% OFF
                        </div>
                        <?php } ?>
